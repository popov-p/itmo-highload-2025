...
![prometheus](../plots/AHLA-3/AHLA-3-prometheus.png)

###### Визуализация dashboards, по которым будет настроен алертинг
- Cpu Usage per instance, %
![grafana-cpu](../plots/AHLA-3/AHLA-3-grafana-cpu-percent.png)
- 
- Mem Usage per instance, %
![grafana-mem](../plots/AHLA-3/AHLA-3-grafana-mem-usage.png)
- 
- Downtime [0 or 1]
![grafana-downtime](../plots/AHLA-3/AHLA-3-grafana-downtime.png)

- Instant rules counter
![grafana-instant](../plots/AHLA-3/AHLA-3-grafana-instant.png)

- Ongoing rules counter
![grafana-ongoing](../plots/AHLA-3/AHLA-3-grafana-ongoing.png)
...
- Ongoing rules counter
![grafana-alerts](../plots/AHLA-3/AHLA-3-grafana-alerts.png)
...
![grafana-alerts](../plots/AHLA-3/AHLA-3-CI.png)
### Выгрузка образов в DockerHub 
Настроена автоматическая выгрузка контейнеров в DockerHub

- Ongoing rules counter
![docker-hub](../plots/AHLA-3/AHLA-3-docker-hub.png)
- 